...
0x48, 0x98, 0xA8, 0x48, 0x00, 0x00, 0x00, 0x00,  //^
0x07, 0x04, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00,  //_
0x0F, 0x1F, 0x1F, 0x3F, 0x3E, 0x38, 0x20, 0x20,  //>
};

void draw_font(void *dest, uint8_t index)
{
    int addr = 0;
    for (int i = (index + 1) * FONT_SIZE - 1; i > index * FONT_SIZE - 1; --i, ++addr)
        ((uint8_t *)dest)[addr] = font[i];
}
